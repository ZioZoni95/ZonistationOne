...
typedef enum {
    ...
    GPU_CMD_VBLANK,
    GPU_CMD_GP0_COMMAND,     // Generic GP0 command
    GPU_CMD_GP1_COMMAND,     // Generic GP1 command
    GPU_CMD_WRAPAROUND,      // FIFO wraparound marker
...
// GP0 command (generic command word)
typedef struct GpuGP0Command {
    GpuCommand header;
    uint32_t command_word;
} GpuGP0Command;

// GP1 command (generic command word)
